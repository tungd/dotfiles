(custom-set-variables
 ...
 '(package-selected-packages
   '(multi-vterm vterm capnp-mode eglot clojure-mode expand-region markdown-mode consult-eglot company-ctags ctags-update ctrlf projectile undo-fu dts-mode cmake-mode kconfig-mode csv-mode org ob-async elixir-mode lua-mode swift-mode kaolin-themes doom-themes consult-flycheck mini-frame flycheck github-theme smart-mode-line yasnippet yaml-mode which-key web-mode use-package typescript-mode tuareg terraform-mode terraform-doc tango-plus-theme sqlformat selectrum-prescient reason-mode rainbow-mode py-isort ob-http ob-graphql nginx-mode magit highlight-numbers haskell-mode golden-ratio feature-mode exec-path-from-shell evil-surround eshell-z eshell-up eshell-toggle emmet-mode dune dockerfile-mode docker delight crux consult company-prescient comment-dwim-2 ace-window))
