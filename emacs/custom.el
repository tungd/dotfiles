(custom-set-variables
 ...
 '(package-selected-packages
   '(avy consult copilot crux csv-mode d2-mode detached diff-hl dune editorconfig
         ...
         modus-theme multiple-cursors ob-async ob-http ob-kotlin ob-plantuml
         ob-redis orderless persp-mode protobuf-mode rainbow-mode reason-mode
         redis rg scad-mode surround tempel terraform-mode tuareg
         undo-fu-session vertico visual-regexp vterm vundo web-beautify web-mode))
