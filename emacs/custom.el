(custom-set-variables
 ...
 '(package-selected-packages
   '(elixir-mode lua-mode swift-mode consult-lsp kaolin-themes doom-themes lsp-python-ms consult-flycheck mini-frame flycheck github-theme smart-mode-line yasnippet yaml-mode which-key web-mode visual-regexp use-package typescript-mode tuareg terraform-mode terraform-doc tango-plus-theme sqlformat selectrum-prescient reason-mode rainbow-mode py-isort ob-http ob-graphql nginx-mode magit highlight-numbers haskell-mode golden-ratio feature-mode expand-region exec-path-from-shell evil-surround eshell-z eshell-up eshell-toggle emmet-mode dune dockerfile-mode docker delight ctrlf crux consult company-prescient comment-dwim-2 ag ace-window))
