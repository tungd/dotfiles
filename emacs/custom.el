(custom-set-variables
 ...
 '(package-selected-packages
   '(github-theme smart-mode-line yasnippet yaml-mode which-key web-mode visual-regexp use-package typescript-mode tuareg terraform-mode terraform-doc tango-plus-theme sqlformat smartparens selectrum-prescient reason-mode rainbow-mode py-isort ob-http ob-graphql nginx-mode magit lsp-pyright inf-clojure highlight-numbers haskell-mode golden-ratio fsharp-mode feature-mode expand-region exec-path-from-shell evil-surround eshell-z eshell-up eshell-toggle emmet-mode dune dockerfile-mode docker delight ctrlf crux consult company-prescient comment-dwim-2 ag ace-window))
