(custom-set-variables
 ...
 '(package-selected-packages
   '(iedit ace-window lsp-pyright lsp-mode vertico orderless treemacs evil-surround undo-fu haskell-mode markdown-mode evil wgrep-ag inf-elixir ob-elixir elixir-mode fsharp-mode dune reason-mode shackle tuareg cmake-mode simpleclip sqlformat csv-mode consult-selectrum consult poetry ob-graphql rainbow-delimiters ag yasnippet yaml-mode which-key web-mode visual-regexp use-package undo-tree typescript-mode terraform-doc tango-plus-theme smartparens rainbow-mode py-isort ob-http nginx-mode magit inf-clojure highlight-numbers hideshow-org golden-ratio feature-mode expand-region exec-path-from-shell eshell-z eshell-up eshell-toggle eshell-git-prompt emmet-mode doom-themes dockerfile-mode docker delight ctrlf crux comment-dwim-2))
