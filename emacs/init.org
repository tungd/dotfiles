...
#+begin_src emacs-lisp
  ...
  (defun td/minibuffer-auto-complete ()
    "Show completions if minibuffer has 2+ characters. It's supposed to be auto, you know."
    (when (and (minibufferp)
               (>= (length (minibuffer-contents)) 2)
               ;; Only complete after text insertion/deletion commands
  ...
  (add-hook 'minibuffer-setup-hook #'td/setup-minibuffer-auto-complete)
...
#+begin_src emacs-lisp
  (custom-theme-set-faces
   ...
   '(line-number ((t :slant normal :background unspecified :foreground "#bbb" :inherit font-lock-comment-face)))
