...
#+begin_src emacs-lisp
  (use-package shackle
    ...
    :custom
    (shackle-rules `((compilation-mode :noselect t :size 0.2 :align 'below)
...
#+begin_src emacs-lisp
  ...
  (bind-key* "C-c RET" #'td/toggle-maximize-buffer)
#+end_src
...
#+BEGIN_SRC emacs-lisp
  (global-eldoc-mode 1)
  (bind-key "C-c l" #'eldoc-print-current-symbol-info)
#+END_SRC
