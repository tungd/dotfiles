...
#+begin_src emacs-lisp
  ...
  (add-to-list 'load-path "~/Projects/personal/ellama")
  (add-to-list 'exec-path "~/.local/bin")
  (add-to-list 'exec-path "/opt/local/bin")
  (add-to-list 'exec-path "/Users/tung/Library/Python/3.12/bin/")
  (add-to-list 'exec-path "/Users/tung/Library/pnpm")
  (add-to-list 'exec-path "/Users/tung/.opam/default/bin/")
...
#+begin_src emacs-lisp
  (use-package codex
    ...
    ;; Configure detection with either `codex-prompt-regexp' or
    ;; `codex-waiting-regexps'. Use M-x codex-detect-dump-tail to inspect
    ;; the last lines and M-x codex-set-waiting-regexp-from-tail to set
    ;; a prompt match quickly.
    :config
    (defun td/codex-notify ()
      "Notify via AppleScript when Codex is waiting for input."
      (when (eq system-type 'darwin)
        (let ((script "display notification \"Codex is waiting for input\" with title \"Codex\""))
    ...
    (setopt gptel-backend
            (gptel-make-anthropic
              ...
              :models '((glm-4.5-air
                         ...
                         :cutoff-date "2024-12")
                        (glm-4.5
                         :description "General Language Model 4.5"
                         :capabilities (media tool-use cache)
                         :context-window 128
                         :input-cost 0.6
                         :output-cost 2.2
...
#+begin_src emacs-lisp :tangle no
  (use-package claudemacs
    :vc (:url "https://github.com/cpoile/claudemacs.git" :branch :main)
