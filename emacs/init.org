...
#+begin_src emacs-lisp
  (defun td/tressit-expand-region ()
    ...
    (if (region-active-p)
        (let* ((bounds (car (region-bounds)))
               (node (treesit-node-on (car bounds) (cdr bounds)))
  ...
  (use-package treesit
    ...
    (add-to-list 'treesit-language-source-alist '(clojure . ("https://github.com/sogaiu/tree-sitter-clojure.git"))))
...
#+begin_src emacs-lisp :tangle no
  (use-package combobulate
    :vc (:url "git@github.com:mickeynp/combobulate.git" :branch "master")
...
#+begin_src emacs-lisp :tangle no
  (defun td/ts-inspect-node-at-point ()
    (interactive)
    (treesit-inspect-node-at-point))

  (bind-key* "C-M-i" #'td/ts-inspect-node-at-point)
#+end_src
...
#+begin_src emacs-lisp :tangle no
  (use-package tango-plus-theme
    ...
    (custom-theme-set-faces
     'user
     '(line-number ((t (:inherit font-lock-comment-face :slant normal))))
...
#+begin_src emacs-lisp
  (use-package doom-themes
    ...
    (custom-theme-set-faces
     'user
     '(line-number ((t (:inherit font-lock-comment-face :slant normal :foreground unspecified))))))
#+end_src
...
#+begin_src emacs-lisp
  (custom-theme-set-faces
   ...
   ;; '(highlight-indentation-face ((t (:inherit font-lock-comment-face))))
   )
#+end_src
