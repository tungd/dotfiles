(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (htmlize hydra hyrdra nginx-mode yasnippet yaml-mode wgrep-ag web-mode use-package undo-tree sublime-themes smex smartparens smart-mode-line realgud rainbow-mode pyvenv purescript-mode psc-ide projectile paren-completer ob-http nlinum nix-mode magit kite-mini intero indent-guide fish-mode exec-path-from-shell emmet-mode editorconfig dumb-jump dockerfile-mode crux counsel comment-dwim-2 better-defaults base16-theme anzu alchemist ag)))
