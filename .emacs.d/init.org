...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package ivy-posframe
    ...
    (set-face-attribute 'ivy-posframe-border nil :background "#fff" :foreground "#fff"))
...
#+BEGIN_SRC text :tangle no
  # Local Variables:
  # eval: (add-hook 'after-save-hook (lambda () (org-babel-tangle) (async-byte-compile-file "~/.emacs.d/init.el")) nil t)
  # End:
#+END_SRC
