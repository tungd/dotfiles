...
** Tracking and tasks management
   ...
   |------------------------+-------------------------------------------------------------|
   | =C-c o a #=            | List stuck projects, which is the one tagged with           |
   |                        | project but doesn't have any TODO. See =org-stuck-projects= |
   |------------------------+-------------------------------------------------------------|
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package org-agenda
       ...
       (setq org-agenda-restore-windows-after-quit t
             ...
             org-stuck-projects
             '("+project/-WAITING-DONE-CANCELLED" ("TODO"))))
   #+END_SRC
